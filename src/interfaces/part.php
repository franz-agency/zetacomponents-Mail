...
abstract class ezcMailPart
{
    ...
    {
        return match ($name) {
            'contentDisposition', 'size' => $this->properties[$name] ?? null,
    ...
    {
        return match ($name) {
            'contentDisposition', 'size' => isset( $this->properties[$name] ),
            "headers" => isset( $this->headers ),
            default => false,
        };
    }
    ...
    public function generateHeaders()
    {
        ...
        foreach ( $this->headers->getCaseSensitiveArray() as $header => $value )
        {
            ...
            switch ( strtolower( $charset ) )
            {
                ...
                case 'utf-8':
                    if ( strpbrk( (string) $value, "" ) === false )
                    {
                        $value = ezcMailHeaderFolder::foldAny( $value );
                        break;
                    }
    ...
    public function appendExcludeHeaders( array $headers )
    {
        ...
        {
            $lowerCaseHeaders[] = strtolower( (string) $header );
        }
